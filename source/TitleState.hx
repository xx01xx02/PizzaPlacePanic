...
class TitleState extends MusicBeatState
{
	...
	public static var unlockedSongs:Array<Bool> = [false, false, false];

	public static var initialized:Bool = false;

	public static var didSaulEgg:Bool;
	...
	override public function create():Void
	{
		...
		if(FlxG.save.data != null) {
            ...
            if (FlxG.save.data.deshredUnlock != null)
                unlockedSongs[1] = FlxG.save.data.deshredUnlock;
			if (FlxG.save.data.milkshakeUnlock != null)
                unlockedSongs[2] = FlxG.save.data.milkshakeUnlock;
			//Shop saving in the main menu
			if (FlxG.save.data.shopBoughtGunspray != null)
                ShopState.hasBought[0] = FlxG.save.data.shopBoughtGunspray;
			if (FlxG.save.data.shopBoughtSelfInsert != null)
                ShopState.hasBought[1] = FlxG.save.data.shopBoughtSelfInsert;
			if (FlxG.save.data.shopBoughtSusarray != null)
                ShopState.hasBought[2] = FlxG.save.data.shopBoughtSusarray;
			...
			if (FlxG.save.data.shopMenusUnlocked != null)
				ShopState.unlockedMenus = FlxG.save.data.shopMenusUnlocked;
			if (FlxG.save.data.currentMenuThemeNumber != null && FlxG.save.data.shopMenusUnlocked != null)
				ShopState.unlockedMenus[ShopState.menuSelected] = FlxG.save.data.currentMenuTheme;
        }
	...
	function startIntro()
	{
		...
		if(rand){
		logoBl.frames = Paths.getSparrowAtlas('susBumpin');
		}
		else {
		...
		switch(easterEgg.toUpperCase())
		{
			...
			//EDIT THIS ONE IF YOU'RE MAKING A SOURCE CODE MOD!!!!
				if(rand){
				gfDance.frames = Paths.getSparrowAtlas('susGfTitle');
				}
				else {
	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 10:
					if(rand){
						createCoolText(['Hi I am Saul Goodman'], -40);
					}
					else {
				...
				case 12:
					if(rand){
						addMoreText('Did you know that', -40);
					}
					else {
